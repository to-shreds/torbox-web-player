import { normalizeSources, targetOf, cleanText, parseSizeBytes } from './source-client.js?v=2.3.2';
import { isTrustedDirectMediaUrl } from './runtime.js?v=2.3.2';

export const DIRECT_BUILD = 'browser-local-2.3.2';
