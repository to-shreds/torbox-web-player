import { DEFAULT_SETTINGS, normalizeSettings, getSettings } from './settings.js?v=2.2.0';
import { listRecent } from './history.js?v=2.2.0';
import { listWatchlist } from './watchlist.js?v=2.2.0';
