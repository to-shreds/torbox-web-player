import { collectPortableSetup, encodePortableSetup, decodePortableSetup, portableSummary, makeSetupUrl, tokenFromText, isProtectedSetup, splitSetupFrames, SetupFrameCollector } from './portable-setup.js?v=2.1.0';
