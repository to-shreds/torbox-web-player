import { createDiscoveryUI } from './discover.js?v=restored12';
import { diagnosePlaybackFailure } from './playback-errors.js?v=restored12';
import { apiUrl, mediaUrl, apiMode, getSessionToken, setSessionToken, clearSessionToken, credentialsMode } from './runtime.js?v=restored12';
import { rememberApiKey, loadRememberedApiKey, forgetApiKey } from './vault.js?v=restored12';
import { createEncryptedTransfer, decryptEncryptedTransfer, applyTransferredState, transferLookup, transferCodeFromHash, buildTransferLink } from './device-transfer.js?v=restored12';
import { listRecent, continueWatchingItems, recordRecent, removeRecentTitle, recentForContext, resumePosition, formatResumeTime } from './history.js?v=restored12';
import { getSettings, saveSettings, resetSettings } from './settings.js?v=restored12';
import { rememberSourceSuccess, setAudioFeedback, setSourceBad, clearSourceMemory } from './source-memory.js?v=restored12';
import { clearSearchHistory } from './search-history.js?v=restored12';
import { hasParentPin, setParentPin, verifyParentPin, getKidProfile, updateKidProfile, resetKidAllowance, grantKidExtension, canStartKidPlayback, consumeKidPlayback, formatKidUsage } from './parental-controls.js?v=restored12';
