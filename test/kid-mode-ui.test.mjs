...
test('Kid Mode module is served and included in the static PWA shell',async()=>{
  ...
  // Version agreement across the release markers is release-update.test.mjs's job. Pinning a
  // literal here only made an unrelated Kid Mode test fail on every version bump.
