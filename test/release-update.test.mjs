...
test('2.0.5 entrypoint and changed browser modules are release-versioned',async()=>{
  ...
  assert.match(html,/src="\.\/app\.js\?v=2\.0\.5"/);
  assert.match(app,/from '\.\/discover\.js\?v=2\.0\.5'/);
  assert.match(app,/from '\.\/direct-runtime\.js\?v=2\.0\.5'/);
  assert.match(discover,/from '\.\/direct-runtime\.js\?v=2\.0\.5'/);
  assert.match(runtime,/browser-local-2\.0\.5/);
});
