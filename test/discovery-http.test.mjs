...
test('same-origin modules are served, API connections stay local, and media is limited to the protected relay', async t => {
  ...
  assert.ok(policy.includes("media-src 'self'")); assert.ok(!policy.includes('tb-cdn.io'));
