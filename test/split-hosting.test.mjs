...
test('canonical HTML uses project-relative assets with Render as the API control plane', async t => {
  const { call }=await fixture(t);
  ...
  assert.ok(html.includes('href="./style.css"')); assert.ok(html.includes('src="./app.js?v=2.3.0"'));
