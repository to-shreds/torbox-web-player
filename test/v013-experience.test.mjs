...
test('PWA shell is installable and refuses to intercept APIs video fallback or other apps',async()=>{
  ...
  const caches={keys:async()=>['arcade-cache','torbox-player-v1.1','torbox-main-v1.9','torbox-main-v2.0.0'],delete:async k=>deleted.push(k),open:async()=>({put:async()=>{},match:async()=>new Response('cached'),addAll:async()=>{}})};
