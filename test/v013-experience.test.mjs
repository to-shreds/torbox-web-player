...
test('PWA shell is installable and refuses to intercept APIs video fallback or other apps',async()=>{
  ...
  const caches={keys:async()=>['arcade-cache','torbox-player-v1.1','torbox-main-v1.9','torbox-main-v2.0.0','torbox-main-v2.0.1','torbox-main-v2.0.2'],delete:async k=>deleted.push(k),open:async()=>({put:async()=>{},match:async()=>new Response('cached'),addAll:async()=>{}})};
  ...
  let activated;handlers.activate({waitUntil:p=>{activated=p;}});await activated;assert.deepEqual(deleted,['torbox-main-v1.9','torbox-main-v2.0.0','torbox-main-v2.0.1','torbox-main-v2.0.2']);
});
