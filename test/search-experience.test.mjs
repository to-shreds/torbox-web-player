...
test('stable release metadata is 2.0.0',async()=>{
  ...
  assert.match(entry,/version: '2\.0\.0'/);
  assert.match(server,/version: '2\.0\.0'/);
  assert.match(sw,/torbox-main-v2\.0\.0/);
  assert.match(readme,/Current version: \*\*2\.0\.0\*\*/);
});
