...
export class Discovery {
  ...
  async register(input, sessionId) {
    ...
    const rows = sources.map(source => {
      ...
      return { id, hash: source.hash, title: source.title, label: source.label, provider: source.provider, providers: source.providers, filename: source.filename, quality: source.quality, hint: source.hint, size: source.size, seeders: source.seeders, releaseQuality: source.releaseQuality, container: source.container, resolution: source.resolution, cached, browserFriendly: source.browserFriendly, browserContainer: source.browserContainer, browserUnsupported: source.browserUnsupported, containerStatus: source.containerStatus, audioRisk: source.audioRisk, videoRisk: source.videoRisk, videoCodec: source.videoCodec, audioCodecs: source.audioCodecs, score: source.score + (cached ? 8 : 0) };
